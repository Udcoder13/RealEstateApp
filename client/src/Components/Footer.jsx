...
export default function Footer() {
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
      <div>
        <h2 class="text-2xl font-semibold">YourCompany</h2>
      ...
      <div>
        ...
        <ul class="mt-4 space-y-2">
          <li><Link to="#" class="hover:text-gray-300">About Us</Link></li>
          <li><Link to="#" class="hover:text-gray-300">Services</Link></li>
          <li><Link to="#" class="hover:text-gray-300">Blog</Link></li>
          <li><Link to="#" class="hover:text-gray-300">Contact</Link></li>
          <li><Link to="#" class="hover:text-gray-300">FAQs</Link></li>
        </ul>
      </div>
    ...
    <div class="mt-8 border-t border-gray-700 pt-4">
      <p class="text-center text-gray-400">&copy; 2024 YourCompany. All rights reserved.</p>
    </div>
  </div>
</footer>
  )
